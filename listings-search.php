...
<?php if( is_post_type('listings')):?>
    ...
    <input type="submit" alt="Search" value="Search" />
							...
							<a id="sale-filter" class="pre-filter-element sl-button" href="?availability[]=for-sale-or-lease&availability[]=for-sale">For Sale</a>
							<a id="lease-filter" class="pre-filter-element sl-button" href="?availability[]=for-sale-or-lease&availability[]=for-lease">For Lease</a>
						</div>
